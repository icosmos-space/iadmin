...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	allMenus := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: 0, Path: "dev", Name: "dev", Component: "view/dev/index.vue", Sort: 5, Meta: Meta{Title: "本系统开发工具", Icon: "tools"}},
		// {MenuLevel: 0, Hidden: false, ParentId: 0, Path: "https://iadmin.icosmos.space", Name: "https://iadmin.icosmos.space", Component: "/", Sort: 0, Meta: Meta{Title: "官方网站", Icon: "customer-gva"}},
	...
	childMenus := []SysBaseMenu{
		...
		// Dev子菜单
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["dev"], Path: "autoCode", Name: "autoCode", Component: "view/dev/autoCode/index.vue", Sort: 1, Meta: Meta{Title: "代码生成器", Icon: "cpu", KeepAlive: true}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["dev"], Path: "formCreate", Name: "formCreate", Component: "view/dev/formCreate/index.vue", Sort: 3, Meta: Meta{Title: "表单生成器", Icon: "magic-stick", KeepAlive: true}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["dev"], Path: "system", Name: "system", Component: "view/dev/system/system.vue", Sort: 4, Meta: Meta{Title: "系统配置", Icon: "operation"}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["dev"], Path: "autoCodeAdmin", Name: "autoCodeAdmin", Component: "view/dev/autoCodeAdmin/index.vue", Sort: 2, Meta: Meta{Title: "自动化代码管理", Icon: "magic-stick"}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["dev"], Path: "loginLog", Name: "loginLog", Component: "view/dev/loginLog/index.vue", Sort: 5, Meta: Meta{Title: "登录日志", Icon: "monitor"}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["dev"], Path: "apiToken", Name: "apiToken", Component: "view/dev/apiToken/index.vue", Sort: 6, Meta: Meta{Title: "API Token", Icon: "key"}},
		{MenuLevel: 1, Hidden: true, ParentId: menuNameMap["dev"], Path: "autoCodeEdit/:id", Name: "autoCodeEdit", Component: "view/dev/autoCode/index.vue", Sort: 0, Meta: Meta{Title: "自动化代码-${id}", Icon: "magic-stick"}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["dev"], Path: "autoPkg", Name: "autoPkg", Component: "view/dev/autoPkg/autoPkg.vue", Sort: 0, Meta: Meta{Title: "模板配置", Icon: "folder"}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["dev"], Path: "exportTemplate", Name: "exportTemplate", Component: "view/dev/exportTemplate/exportTemplate.vue", Sort: 5, Meta: Meta{Title: "导出模板", Icon: "reading"}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["dev"], Path: "skills", Name: "skills", Component: "view/dev/skills/index.vue", Sort: 6, Meta: Meta{Title: "Skills管理", Icon: "document"}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["dev"], Path: "picture", Name: "picture", Component: "view/dev/autoCode/picture.vue", Sort: 6, Meta: Meta{Title: "AI页面绘制", Icon: "picture-filled"}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["dev"], Path: "mcpTool", Name: "mcpTool", Component: "view/dev/autoCode/mcp.vue", Sort: 7, Meta: Meta{Title: "Mcp Tools模板", Icon: "magnet"}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["dev"], Path: "mcpTest", Name: "mcpTest", Component: "view/dev/autoCode/mcpTest.vue", Sort: 7, Meta: Meta{Title: "Mcp Tools测试", Icon: "partly-cloudy"}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["dev"], Path: "sysVersion", Name: "sysVersion", Component: "view/dev/version/version.vue", Sort: 8, Meta: Meta{Title: "版本管理", Icon: "server"}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["dev"], Path: "sysError", Name: "sysError", Component: "view/dev/sysError/sysError.vue", Sort: 9, Meta: Meta{Title: "错误日志", Icon: "warn"}},
		...
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["plugin"], Path: "installPlugin", Name: "installPlugin", Component: "view/dev/installPlugin/index.vue", Sort: 1, Meta: Meta{Title: "插件安装", Icon: "box"}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["plugin"], Path: "pubPlug", Name: "pubPlug", Component: "view/dev/pubPlug/pubPlug.vue", Sort: 3, Meta: Meta{Title: "打包插件", Icon: "files"}},
