...
{{- if .HasDataSource }}
func ({{.Abbreviation}}Service *{{.StructName}}Service)Get{{.StructName}}DataSource(ctx context.Context, info commonReq.DataSourceQuery) (res commonReq.DataSourceResult, err error) {
	if info.Page <= 0 {
		info.Page = 1
	}
	switch {
