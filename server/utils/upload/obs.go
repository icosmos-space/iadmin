...
func NewHuaWeiObsClient() (client *obs.ObsClient, err error) {
	return obs.New(global.IADMIN_CONFIG.HuaWeiObs.AccessKey, global.IADMIN_CONFIG.HuaWeiObs.SecretKey, global.IADMIN_CONFIG.HuaWeiObs.Endpoint)
}
...
func (o *Obs) UploadFile(file *multipart.FileHeader) (string, string, error) {
	...
	input := &obs.PutObjectInput{
		PutObjectBasicInput: obs.PutObjectBasicInput{
			ObjectOperationInput: obs.ObjectOperationInput{
				Bucket: global.IADMIN_CONFIG.HuaWeiObs.Bucket,
				Key:    filename,
			},
	...
	filepath := global.IADMIN_CONFIG.HuaWeiObs.Path + "/" + filename
